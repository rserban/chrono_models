...
//=========================================================================================================
	...
	InitObject(leg_FL, 60 / 1.0, ChVector<>(-(axleL + legW) / 2.0, offsety - .1, chassisL / 2.0 + .2), Q_from_AngZ(CH_C_PI / 2.0), material_wheel, false, true, -2, 0);
	InitObject(leg_RR, 60 / 1.0, ChVector<>((axleL + legW) / 2.0, offsety - .1, -chassisL / 2.0), Q_from_AngZ(CH_C_PI / 2.0), material_wheel, false, true, -2, 0);
