...
real timestep = .0005;
real seconds_to_simulate = timestep * 1;
...
//=========================================================================================================
	...
	((ChLcpSolverParallelDVI *) (system_gpu->GetLcpSolverSpeed()))->SetTolerance(1e-4);
	((ChLcpSolverParallelDVI *) (system_gpu->GetLcpSolverSpeed()))->SetCompliance( .0);
	((ChLcpSolverParallelDVI *) (system_gpu->GetLcpSolverSpeed()))->SetContactRecoverySpeed(25);
	if (solver == 0) {
		cout<<"APGD"<<endl;
	...
	((ChLcpSolverParallelDVI *) (system_gpu->GetLcpSolverSpeed()))->solver.SetAPGDParams(1,.9,2.0);
...
//layer_gen->loadAscii("bunny.txt", R3(0, 2, 0), SPHERE, R3(.0235, 0, 0), R3(0, -10, 0), R3(2, 2, 2));
	layer_gen->loadAscii("bunny.txt", R3(0, 2, 0), SPHERE, R3(.03, 0, 0), R3(0, -10, 0), R3(2, 2, 2));
